...
//        System.out.println(jee.getVedenkorkeus(1,3));
        ...
        System.out.println(testiMaa.getMaankorkeus(5, 5));
        System.out.println(testiMaa.getMaankorkeus(5, 6));
        ...
        System.out.println(testiMaa.getVedenkorkeus(4, 4));
        System.out.println(testiMaa.getVedenkorkeus(5, 4));
    }
}
